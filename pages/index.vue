<template>
  <div class="antialiased">
    ...
    <div class="-skew-y-3 my-36 ">
	  ...
	  <div class="bg-slate-800">
		<div class="relative px-8 py-48 m-auto text-white skew-y-3 max-w-8xl">
			...
			<p class="mb-8">Below are a list of tools I consider essential to development. <br/> These tend to be the first applications to get installed and provide great developer experiences.</p>
			<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
				<a href="#" target="_blank" class="flex items-center p-4 shadow-[3px_3px_rgba(255,255,255,0.35)] font-bold bg-slate-100 text-slate-800  transition 
					hover:shadow-yellow-500 hover:bg-white
	...
	<div class="relative">
		<div
        class="absolute inset-0 grid-bg top-1"
        style="mask-image: linear-gradient(to bottom, transparent, black);-webkit-mask-image: linear-gradient(to bottom, transparent, black);"
      	></div>
		<div class="relative px-8 py-24 m-auto text-slate-800 max-w-8xl">
			<h2 class="mb-8 text-6xl font-extrabold leading-snug">Topics of Interest</h2>
			<p class="my-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure earum, eius exercitationem placeat odit quis cum dolorum fugiat cumque incidunt repellat, doloribus recusandae aliquam optio natus tempore voluptas hic delectus! Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium fuga eius consequatur quae unde nihil pariatur magni ut cupiditate? Ipsum, beatae? Hic eaque ex voluptatibus sed quisquam assumenda similique dolores. Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, facilis deleniti! Tenetur officiis, repellat, est a dolorum, quidem vero corrupti velit pariatur sit porro aliquid sunt reiciendis tempora eos aliquam.</p>
			<p class="my-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure earum, eius exercitationem placeat odit quis cum dolorum fugiat cumque incidunt repellat, doloribus recusandae aliquam optio natus tempore voluptas hic delectus! Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium fuga eius consequatur quae unde nihil pariatur magni ut cupiditate? Ipsum, beatae? Hic eaque ex voluptatibus sed quisquam assumenda similique dolores. Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, facilis deleniti! Tenetur officiis, repellat, est a dolorum, quidem vero corrupti velit pariatur sit porro aliquid sunt reiciendis tempora eos aliquam.</p>
		</div>
	</div>
  </div>
