                ...
                <ul class="flex flex-col max-w-6xl gap-16 mt-24">
                    <li v-for="article of articles" :key="article.slug">
                        <div class="mb-4">
                            ...
                            <span class="text-sm text-slate-600 dark:text-slate-300">{{ formatDate(article.createdAt) }}</span>
                        </div>
                        <p class="text-lg text-slate-600 dark:text-slate-300">{{ article.description }}</p>
